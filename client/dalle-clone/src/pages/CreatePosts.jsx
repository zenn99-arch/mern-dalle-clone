  ...
  return (
    <section className='max-w-7xl mx-auto' >
      ...
      <div className="flex flex-col gap-5">
        <FormField LableName='your name' type='text' name='name' palceholder='john doe' value={form.name} handleChange={handleChange} />
        <FormField LableName='prompt' type='text' name='prompt' palceholder='3D render of a cute tropical fish in an aquarium on a dark blue background, digital art' value={form.prompt} handleChange={handleChange} isSurpriseMe handleSurpriseMe={handleSurpriseMe} />
